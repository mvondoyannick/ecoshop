...
class ProduitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produit" do
    assert_difference("Produit.count") do
      post produits_url, params: { produit: { category: @produit.category, name: @produit.name, udm: @produit.udm, udm_value: @produit.udm_value } }
    end
  ...
  test "should update produit" do
    patch produit_url(@produit), params: { produit: { category: @produit.category, name: @produit.name, udm: @produit.udm, udm_value: @produit.udm_value } }
